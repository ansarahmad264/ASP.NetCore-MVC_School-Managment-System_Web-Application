...
namespace SchoolManagmentSystem.Migrations
{
    ...
    [Migration("20250511202404_AddFeePaymentsandFeeSchedule")]
    partial class AddFeePaymentsandFeeSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagmentSystem.Models.FeePayment", b =>
                {
            ...
            modelBuilder.Entity("SchoolManagmentSystem.Models.FeeSchedule", b =>
                {
                    b.Property<int>("FeeScheduleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FeeScheduleId"));
            ...
            modelBuilder.Entity("SubjectMark", b =>
                {
                    b.Property<int>("SubjectMarkId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SubjectMarkId"));
            ...
            modelBuilder.Entity("ExamResult", b =>
                {
                    b.HasOne("SchoolManagmentSystem.Models.Enrollment", "Enrollment")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagmentSystem.Models.FeePayment", b =>
                {
                    b.HasOne("SchoolManagmentSystem.Models.FeeSchedule", "FeeSchedule")
                        .WithMany()
            ...
            modelBuilder.Entity("SubjectMark", b =>
                {
                    b.HasOne("ExamResult", "ExamResult")
